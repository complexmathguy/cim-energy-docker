...
public class DiagramObjectAggregate {  
    ...
    public DiagramObjectAggregate(CreateDiagramObjectCommand command) throws Exception {
    	...
    	CreateDiagramObjectEvent event = new CreateDiagramObjectEvent(command.getDiagramObjectId(), command.getDrawingOrder(), command.getPolygonFlag(), command.getOffsetX(), command.getOffsetY(), command.getRotation());
    ...
    public void handle(UpdateDiagramObjectCommand command) throws Exception {
    	...
    	UpdateDiagramObjectEvent event = new UpdateDiagramObjectEvent(command.getDiagramObjectId(), command.getDrawingOrder(), command.getPolygonFlag(), command.getOffsetX(), command.getOffsetY(), command.getRotation());        
