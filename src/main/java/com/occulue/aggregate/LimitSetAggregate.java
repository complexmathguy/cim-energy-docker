...
public class LimitSetAggregate {  
    ...
    public LimitSetAggregate(CreateLimitSetCommand command) throws Exception {
    	...
    	CreateLimitSetEvent event = new CreateLimitSetEvent(command.getLimitSetId(), command.getPercentageLimitsFlag());
    ...
    public void handle(UpdateLimitSetCommand command) throws Exception {
    	...
    	UpdateLimitSetEvent event = new UpdateLimitSetEvent(command.getLimitSetId(), command.getPercentageLimitsFlag());        
    ...
    private String percentageLimitsFlag;
