...
class UpdateDiagramObjectComponent extends Component {
    constructor(props) {
        ...
        this.changepolygonFlagHandler = this.changepolygonFlagHandler.bind(this);
    ...
    componentDidMount(){
        DiagramObjectService.getDiagramObjectById(this.state.id).then( (res) =>{
            ...
            this.setState({
                ...
                polygonFlag: diagramObject.polygonFlag,
    ...
    changepolygonFlagHandler= (event) => {
        this.setState({polygonFlag: event.target.value});
    }
