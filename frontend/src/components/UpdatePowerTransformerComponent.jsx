...
class UpdatePowerTransformerComponent extends Component {
    constructor(props) {
        ...
        this.changepartOfGeneratorUnitFlagHandler = this.changepartOfGeneratorUnitFlagHandler.bind(this);
    ...
    componentDidMount(){
        PowerTransformerService.getPowerTransformerById(this.state.id).then( (res) =>{
            ...
            this.setState({
                ...
                partOfGeneratorUnitFlag: powerTransformer.partOfGeneratorUnitFlag,
    ...
    updatePowerTransformer = (e) => {
        ...
        let powerTransformer = {
            ...
            partOfGeneratorUnitFlag: this.state.partOfGeneratorUnitFlag,
    ...
    changepartOfGeneratorUnitFlagHandler= (event) => {
        this.setState({partOfGeneratorUnitFlag: event.target.value});
    }
                                ...
                                <div className = "card-body">
                                    <form>
                                        <div className = "form-group">
                                            ...
                                            #formFields( $attribute, 'update')
                                            <label> partOfGeneratorUnitFlag: </label>
                                            #formFields( $attribute, 'update')
